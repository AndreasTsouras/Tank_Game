#ifndef TANKGAME_MATRIX_H
#define TANKGAME_MATRIX_H
...
public:
    ...
    // Overloaded translate function with Vector3f
    ...
    // Example method to set the matrix data
