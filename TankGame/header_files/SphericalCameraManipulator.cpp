...
Matrix4x4 SphericalCameraManipulator::getMVMatrix()
{
    // Compute the model-view matrix based on the camera's position, orientation, and zoom level
    Matrix4x4 modelViewMatrix = this->apply(Matrix4x4());

    // Return the model-view matrix as a Matrix4x4 object
    return modelViewMatrix;
}

Matrix4x4 SphericalCameraManipulator::getProjectionMatrix() const
{
